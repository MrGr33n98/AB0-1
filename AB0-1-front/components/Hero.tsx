  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="block w-full rounded-full pl-10 pr-4 py-3 text-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent border border-border shadow-md"
