      ...
      if (selectedProduct) {
        ...
        setProducts(products.map(p =>
          p.id === selectedProduct.id
            ? { ...p, ...data, price: data.price.toString() }
            : p
        ));
        toast({
          title: 'Produto atualizado!',
          description: 'As alterações foram enviadas para aprovação.',
        });
      } else {
        // Create
        ...
        toast({
          ...
          description: 'O novo produto foi enviado para aprovação.',
        });
      }
...
const mockProducts: Product[] = [
  {
    id: '1',
    name: 'Consultoria de Arquitetura Residencial',
    description: 'Consultoria completa para projetos residenciais, incluindo análise de viabilidade, conceito e desenvolvimento.',
    short_description: 'Consultoria completa para projetos residenciais',
    price: 'R$ 3.500,00',
    company_id: '1',
    sku: 'CONS-001',
    stock: 10,
    status: 'active',
    featured: true,
    seo_title: 'Consultoria de Arquitetura Residencial - Projetos Personalizados',
    seo_description: 'Serviço de consultoria arquitetônica especializada em projetos residenciais.',
  },
  {
    id: '2',
    name: 'Projeto Arquitetônico Comercial',
    description: 'Desenvolvimento completo de projeto arquitetônico para estabelecimentos comerciais.',
    short_description: 'Projetos arquitetônicos comerciais',
    price: 'R$ 8.900,00',
    company_id: '1',
    sku: 'PROJ-002',
    stock: 5,
  ...
  },
  {
    ...
    description: 'Projeto de design de interiores personalizado para ambientes residenciais e comerciais.',
    price: 'R$ 2.500,00',
    company_id: '1',
    status: 'pending',
    featured: false,
