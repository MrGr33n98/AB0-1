    ...
    setReviews([
      {
        id: '1',
        rating: 5,
        comment: 'Excelente empresa! Profissionais muito competentes e atenciosos. O projeto ficou melhor do que esperávamos.',
      ...
      },
      {
        id: '2',
        rating: 4.5,
        comment: 'Ótimo atendimento e qualidade no serviço. Recomendo!',
      ...
      },
      {
        id: '3',
        rating: 5,
        comment: 'Superou todas as expectativas. Equipe profissional e dedicada.',
