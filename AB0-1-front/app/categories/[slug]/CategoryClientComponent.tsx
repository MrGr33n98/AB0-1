...
import { fetchCategoryBySlug, Category, Company, companiesApi } from '@/lib/api';
...
export default function CategoryClientComponent({ initialCategory, initialCompanies }: CategoryClientProps) {
